...
const GunubirlikHero = () => {
  return (
    <div className="GunubirlikTurlar w-full min-h-[calc(85vh-80px)] lg:h-[calc(85vh-80px)] mt-10 flex flex-col items-center justify-center relative pt-12 px-4 text-white overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center justify-center text-center gap-6 lg:gap-10 w-full max-w-6xl mx-auto mt-10 lg:mt-20">
        <div className="flex justify-center items-center gap-3 lg:gap-5 flex-wrap w-full">
          <Image src={badge2} alt="badge1" className="w-24 sm:w-32 md:w-40 lg:w-48 object-contain" />
          <Image src={badge1} alt="badge2" className="w-24 sm:w-32 md:w-40 lg:w-48 object-contain" />
          <Image src={badge3} alt="badge3" className="w-24 sm:w-32 md:w-40 lg:w-48 object-contain" />
          <Image src={badge4} alt="badge4" className="w-24 sm:w-32 md:w-40 lg:w-48 object-contain" />
        </div>
        <div className="w-full flex justify-center mt-4">
          <Image src={badge5} alt="badge5" className="w-64 sm:w-80 md:w-96 lg:w-100 object-contain" />
        </div>
      </div>
    </div>
  );
