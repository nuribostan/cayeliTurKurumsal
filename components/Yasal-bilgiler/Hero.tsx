      ...
      <div className="iletisim-content w-full h-full flex-col justify-start items-start bg-white pt-20 pb-10 px-10 max-md:px-5">
        <div className="iletisim-item flex flex-col justify-start items-start gap-2.5 border-b border-[#979797] py-5">
          ...
          <ul className="flex flex-col items-start justify-start gap-2.5 pl-5">
            <li className="text-black text-lg flex items-center gap-2.5">
        ...
        <div className="iletisim-item flex flex-col justify-start items-start gap-2.5 border-b border-[#979797] py-5">
          ...
          <ul className="flex flex-col items-start justify-start gap-2.5 pl-5">
            ...
            <li className="text-black text-lg flex items-center gap-2.5">
              <span className="w-2 h-2 rounded-full bg-black"></span>
              <p className="text-black text-lg text-justify">Havayollarının</p>
            </li>

            <li className="text-black text-lg flex items-center gap-2.5">
              <span className="w-2 h-2 rounded-full bg-black"></span>
              <p className="text-black text-lg text-justify">Otellerin</p>
            </li>
        ...
        <div className="iletisim-item flex flex-col justify-start items-start gap-2.5 py-5">
          ...
          <ul className="flex flex-col items-start justify-start gap-2.5 pl-5">
            <li className="text-black text-lg flex items-center gap-2.5">
              <span className="w-2 h-2 rounded-full bg-black"></span>
              <p className="text-black text-lg text-justify">Ad, soyad</p>
            </li>
            ...
            <li className="text-black text-lg flex items-center gap-2.5">
              <span className="w-2 h-2 rounded-full bg-black"></span>
              <p className="text-black text-lg text-justify">E-posta adresi</p>
            </li>
          ...
          <p className="text-black text-lg text-justify">İşleme Amaçları:</p>
          <ul className="flex flex-col items-start justify-start gap-2.5 pl-5">
            <li className="text-black text-lg flex items-center gap-2.5">
              <span className="w-2 h-2 rounded-full bg-black"></span>
              <p className="text-black text-lg text-justify">
          ...
          <p className="text-black text-lg text-justify">KVKK kapsamında;</p>
