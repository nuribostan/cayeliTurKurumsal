...
const GunubirlikHero = () => {
  ...
  useEffect(() => {
    const fetchHeroBg = async () => {
      try {
        const FETCH_URL =
          "https://raw.githubusercontent.com/nuribostan/cayeliTurKurumsalData/refs/heads/main/yurtDisiHero.json";
      ...
      <div className="z-10 flex flex-col items-center justify-center text-center gap-6 lg:gap-10 w-full max-w-6xl mx-auto mt-10 lg:mt-20">
        ...
        <div className="w-full flex justify-center mt-4">
          <Image
            src={badge5}
            alt="badge5"
            className="w-64 sm:w-80 md:w-96 lg:w-90 object-contain"
          />
        </div>
      </div>
    </div>
